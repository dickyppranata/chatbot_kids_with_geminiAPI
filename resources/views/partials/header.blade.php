...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-slate-200/60 px-4 md:px-8 py-3.5 flex items-center justify-between transition-colors">
    ...
    <div class="flex items-center gap-3">
        <!-- Mobile menu toggle -->
        <button id="mobileSidebarToggle" class="md:hidden w-10 h-10 rounded-2xl bg-slate-100 text-slate-700 flex items-center justify-center hover:bg-slate-200 transition-colors">
