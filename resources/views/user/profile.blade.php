...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6 animate-fade-in">
        <!-- Header Page -->
        <div
            class="bg-gradient-to-r from-terracotta/10 via-amber-500/10 to-transparent border border-terracotta/20 rounded-3xl p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <div
                    class="w-16 h-16 bg-gradient-to-br from-terracotta to-amber-500 rounded-2xl flex items-center justify-center text-white text-3xl shadow-md font-extrabold font-outfit">
        ...
        @if(session('success'))
            <div
                class="px-4 py-3 rounded-2xl bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm font-medium flex items-center gap-2">
        ...
        @if($errors->any())
            <div
                class="px-4 py-3 rounded-2xl bg-red-50 border border-red-200 text-red-700 text-sm font-medium flex items-center gap-2">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="bg-white border border-slate-200/60 rounded-3xl p-6 shadow-sm space-y-4">
                ...
                <form action="/profile/password" method="POST" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        <label for="current_password" class="block text-xs font-outfit font-bold text-slate-700">Password
                            Saat Ini</label>
                    ...
                    <div class="space-y-1.5">
                        <label for="password" class="block text-xs font-outfit font-bold text-slate-700">Password
                            Baru</label>
                    ...
                    <div class="space-y-1.5">
                        <label for="password_confirmation"
                            class="block text-xs font-outfit font-bold text-slate-700">Konfirmasi Password Baru</label>
